...
تأكد من الآتي:
1. الأسئلة دقيقة وتعكس المفاهيم المهمة في النص.
2. توفير 4 خيارات لكل سؤال.
3. الإجابة الصحيحة يجب أن تكون متطابقة حرفياً مع أحد الخيارات الأربعة.
4. يجب أن يكون الرد بصيغة JSON فقط، بدون أي نصوص إضافية أو علامات Markdown مثل \`\`\`json.
الهيكل المطلوب:
